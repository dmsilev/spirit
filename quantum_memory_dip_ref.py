...
if __name__ == '__main__':
    ...
    # Save raw data
    df_all.to_csv(
        get_unique_filename(f'Susceptibility_v3_multi_gammas_{dim}_{n_cycles}_per_gamma_{concentration}_anisotropy_{anisotropy}_gamma_{gamma}_ref_1.csv'),
        index=False)
    ...
    fig.write_html(
        get_unique_filename(f'Susceptibility_v3_multi_gamma_{dim}_{n_cycles}_{concentration}_anisotropy_{anisotropy}_gamma_{gamma}_relaxstepzero_{relax_steps_0}ref_1.html'))

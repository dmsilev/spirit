  ...
  Module_Spirit()
    ...
    .then(function() {
      ...
      function updateBackgroundColor() {
        ...
        var colors = {'white' : [ 1.0, 1.0, 1.0 ], 'gray' : [ 0.5, 0.5, 0.5 ], 'black' : [ 0.0, 0.0, 0.0 ]};
        var boundingBoxColors = {'white' : [ 0.0, 0.0, 0.0 ], 'gray' : [ 1.0, 1.0, 1.0 ], 'black' : [ 1.0, 1.0, 1.0 ]};
      ...
      function updateRenderers() {
        ...
        // var coordinateSystemPosition = JSON.parse($("option:selected",
        // $('#select-coordinatesystem-position'))[0].value); var miniViewPosition =
        // JSON.parse($("option:selected", $('#select-miniview-position'))[0].value);
